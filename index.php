                    ...
                    <nav class="navbar">
                          <div class="container-fluid">
                                <div class="navbar-header col-md-3 col-sm-12 col-xs-12 ">
                                    <a class="navbar-brand" href="#"><span>TRA</span>MASS</a>
                                </div>
...
$(document).scroll(function(){
    ...
    if(wScroll > $('.header_heading').offset().top){
        
        $( "#scroll_navbar" ).fadeIn( "fast", function() {
            // Animation complete.
        });
    ...
    if(wScroll < $('.header_heading').offset().top){
        ...
        $( "#scroll_navbar" ).fadeOut( "fast", function() {
            // Animation complete.
        });
